...
import { AppAutenticarOutModel, AppClaveCambiarOutModel, AppGenClaveOlvidoOutModel, AppGenClaveOutModel, AppValidarGenClaveOutModel, PersonaLoginModel, PersonaSelloSegModel, SelloSegAuthOutModel } from '@shared/models/auth/auth.models';
...
export class AuthService {
  ...
  appClaveCambiar(params: AppClaveCambiarOutModel) {
    const paramsOut = { ...params };
    // return this.http.get<ResponseModel<number>>(this.baseAuth).pipe(
    //   map(x => 1)
    // );
  ...
  RESP_LIST_SELLOS: SelloSeguridadModel[] = [
    {intCodSello: 1,
      strDescripcion: "barco",
      bytSello: "",}
  ]
